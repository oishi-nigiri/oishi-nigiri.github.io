      ...
      <div class="modal-container">
        <div class="modal-header">
          <div class="modal-header-content">
            ...
            <div>
              <h2>{{ member ? 'Modifier un Membre' : 'Ajouter un Membre' }}</h2>
              <p class="modal-subtitle">{{ member ? 'Modifiez les informations du membre' : 'Ajoutez un nouveau membre à l\'équipe' }}</p>
            </div>
          </div>
        ...
        <form @submit.prevent="handleSubmit" class="modal-body">
          <div class="form-grid">
            ...
            <div class="form-group">
              ...
              <select id="member-role" v-model="formData.role" required>
                <option value="">Sélectionner un grade</option>
                <option v-for="rank in ranks" :key="rank.id" :value="rank.name">{{ rank.name }}</option>
              </select>
            </div>
